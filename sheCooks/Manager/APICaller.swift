...
struct RecipeView: Identifiable{
    let id: Int
    let title: String
    let image: String
...
let headers = [
    "X-RapidAPI-Key": "61334f56e2msh54e59e54dfb548cp11e3ebjsn8c0e22bec740",
...
class APICaller{
    ...
    //func getRecipesByIngridients(with ingredients: [String])
    func getRecipesByIngridients(){
        
        var request = URLRequest(url: URL(string: "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?ingredients=apples%2Cflour%2Csugar&number=5&ignorePantry=true&ranking=1.json")!)
    ...
    //func getRecipeInformation(recipe id: Int)
    func getRecipeInformation(){
        
        var request = NSMutableURLRequest(url: NSURL(string: "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/479101/information")! as URL,
